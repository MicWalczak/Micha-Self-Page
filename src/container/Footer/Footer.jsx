  ...
  return (
    <>
      <h2 className="head-text">
        If you are interested in working with me,<br /> please see the links below or
        send me an e-mail
      </h2>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card">
          ...
          <a href="mailto:maikiwebdesign@gmail.com" className="p-text"> Maikiwebdesign@gmail.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="mobile" />
          <a href="https://api.whatsapp.com/send/?phone=48884837792&text&type=phone_number&app_absent=0" className="p-text"> WhatsApp</a>
        </div>
      </div>
